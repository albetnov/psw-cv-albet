<div
    ...
    <button
        class="block ml-auto ripple-bg-purple-400 hover:shadow-md hover:shadow-purple-700 text-white py-3 px-8 rounded-full font-bold font-serif mt-3 hover:bg-purple-600 focus:outline-none">Hire
        Me
        &#128075;</button>
</div>
